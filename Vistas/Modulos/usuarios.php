<html>
   ...
   <!-- ***** Welcome Area Start ***** -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s">
                            <div class="features-small-item">
                                <div class="icon">
                                    <i><img src="../img/usuarios/featured-item-01.png" alt=""></i>
                                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-12 col-sm-12 align-self-center" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                    <img src="../img/usuarios/left-image.png" class="rounded img-fluid d-block mx-auto" alt="App">
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-12 col-sm-12 align-self-center mobile-bottom-fix-big" data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                    <img src="../img/usuarios/right-image.png" class="rounded img-fluid d-block mx-auto" alt="App">
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="row">
                    <div class="col-lg-2 col-md-3 col-sm-6 col-6">
                        <a href="#" class="mini-box">
                            <i><img src="../img/usuarios/work-process-item-01.png" alt=""></i>
    ...
    <!-- jQuery -->
    <script src="../js/usuarios-js/jquery-2.1.0.min.js"></script>

    <!-- Bootstrap -->
    <script src="../js/usuarios-js/popper.js"></script>
    <script src="../js/usuarios-js/bootstrap.min.js"></script>

    <!-- Plugins -->
    <script src="../js/usuarios-js/scrollreveal.min.js"></script>
    <script src="../js/usuarios-js/waypoints.min.js"></script>
    <script src="../js/usuarios-js/jquery.counterup.min.js"></script>
    <script src="../js/usuarios-js/imgfix.min.js"></script> 
    
    <!-- Global Init -->
    <script src="../js/usuarios-js/custom.js"></script>
